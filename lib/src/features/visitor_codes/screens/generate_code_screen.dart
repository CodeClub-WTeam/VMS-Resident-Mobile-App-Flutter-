...
// NOTE: If you are still seeing the 'missing_required_argument' error,
// the fix needs to be here. Example: unitId: resident.unitId
);
...
'Date & Time', // Changed label for simplicity

style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: _goldColor), // Gold text
